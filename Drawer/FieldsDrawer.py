...
plt.plot(10, 0.0, 'ro', color = 'red')


plt.subplot().add_patch(Rectangle((0.001, -8000.0), 9999.999, 8000, facecolor = "#b34b06"))
plt.subplot().add_patch(Rectangle((0.001, 0.0), 9999.999, 2000, facecolor = "#1f4af7"))
