...
public static class MeshGenerator
{
    ...
    //private static readonly string _borders3DPath = Path.GetFullPath("../../../../Data/Subtotals/3_dim/");
...
#region 3Dim
    ...
    public static void ConstructMesh(ref Mesh3Dim mesh)
    {
        ...
        var arr = OutputPoints(ref mesh); // Долговато.
    ...
    public static void ConstructMesh(ref Mesh3Dim mesh, Layer layer, int layerNum)
    {
        ...
        GenerateListOfRibs(ref mesh, arr, layerNum); // Долговато.
