...
public static class BasisFunctions2D
{
    ...
    */
    ...
    private static double R1(double r1, double r0, double r) => (r1 - r) / (r1 - r0);

    private static double R2(double r1, double r0, double r) => (r - r0) / (r1 - r0);

    private static double Z1(double z1, double z0, double z) => (z1 - z) / (z1 - z0);

    private static double Z2(double z1, double z0, double z) => (z - z0) / (z1 - z0);
}
...
public static class BasisFunctions3D
{
    ...
    */
    ...
    private static double X1(double x1, double x0, double x) => (x1 - x) / (x1 - x0);

    private static double X2(double x1, double x0, double x) => (x - x0) / (x1 - x0);

    private static double Y1(double y1, double y0, double y) => (y1 - y) / (y1 - y0);

    private static double Y2(double y1, double y0, double y) => (y1 - y) / (y1 - y0);

    private static double Z1(double z1, double z0, double z) => (z1 - z) / (z1 - z0);

    private static double Z2(double z1, double z0, double z) => (z1 - z) / (z1 - z0);
}